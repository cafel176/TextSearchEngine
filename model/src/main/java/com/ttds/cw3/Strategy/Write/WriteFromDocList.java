...
public final class WriteFromDocList extends WriteStrategy<ArrayList<Doc>>
{
    @Override
    public boolean write(String file, ArrayList<Doc> list, String encoding)
    {
        ...
        try
        {
            ...
            {
                bufferedWriter.write(list.get(i).getText()+"\n");
            }
